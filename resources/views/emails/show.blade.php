...
@section('content')
  ...
  <div class="bg-white shadow-md rounded-lg p-6 space-y-4">
    ...
    <div class="mt-10">
      ...
      <form action="{{ route('emails.sendTest', $template->getTemplateId()) }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="flex justify-between items-center pt-4">
          <form action="{{ route('emails.index') }}" method="GET">
            <button type="submit"
                    class="bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium px-4 py-2 rounded-lg shadow">
